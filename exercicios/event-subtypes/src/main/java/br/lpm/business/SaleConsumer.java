...
public class SaleConsumer extends EventConsumer {
    ...
    public SaleConsumer(Stream stream) {
        super();
    ...
    public void updateStatistics(Event event) {
        Sale sale = (Sale) event.getBody();
        updateValueStatistics(sale.getValue());
        updateIdentifierCount(sale.getOrigin());
        updateAttributeCount(sale.getDescription());
    }
