...
public class TicketConsumer extends EventConsumer {
    ...
    public TicketConsumer(Stream stream) {
        super();
    ...
    public void updateStatistics(Event event) {
        Ticket ticket = (Ticket) event.getBody();
        updateValueStatistics(ticket.getValue());
        updateIdentifierCount(ticket.getEvent());
        updateAttributeCount(ticket.getAddress());
    }
